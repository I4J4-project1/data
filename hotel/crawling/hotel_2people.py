...
# csv writer 설정
hotel_2n3d = open("C:/Users/jiyeon/Desktop/project1/hotel/2_name_23.csv", 'w', newline="")
writer_2n3d = csv.writer(hotel_2n3d)
price_2n3d = open("C:/Users/jiyeon/Desktop/project1/hotel/2_price_23.csv", 'w', newline="")
writer_2n3d_2 = csv.writer(price_2n3d)

hotel_3n4d = open("C:/Users/jiyeon/Desktop/project1/hotel/2_name_34.csv", 'w', newline="")
writer_3n4d = csv.writer(hotel_3n4d)
price_3n4d = open("C:/Users/jiyeon/Desktop/project1/hotel/2_price_34.csv", 'w', newline="")
writer_3n4d_2 = csv.writer(price_3n4d)

hotel_4n5d = open("C:/Users/jiyeon/Desktop/project1/hotel/2_name_45.csv", 'w', newline="")
writer_4n5d = csv.writer(hotel_4n5d)
price_4n5d = open("C:/Users/jiyeon/Desktop/project1/hotel/2_price_45.csv", 'w', newline="")
...
# 웹페이지 해당 주소 이동
driver.get("https://hotels.naver.com/list?placeFileName=place%3AJeju_Province&adultCnt=2&checkIn=2023-06-01&checkOut=2023-06-02&includeTax=false&sortField=popularityKR&sortDirection=descending")
time.sleep(10)
